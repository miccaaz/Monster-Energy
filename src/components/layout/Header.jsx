...
const Header = () => {
  return (
    <header className='sticky top-0 z-20 flex justify-center items-center gap-5 w-screen border-b border-gray-600'>
      <div className='bg-black-grey fixed top-0 left-0 py-4 px-8 rounded-br-4xl'>
        <img src={Logo} alt="Monster Logo" className='max-h-20'/>
      </div>
      <nav className='flex justify-center items-center py-5 w-screen bg-black'>
